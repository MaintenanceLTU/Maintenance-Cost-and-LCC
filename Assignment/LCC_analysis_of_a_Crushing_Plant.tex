...
Perform the same calculations as in Task 1, assuming an additional MTBF. Each \textbf{1\% extra MTBF} increases the investment cost by \textbf{125,000 SEK}. Compute the \textbf{NPV for 10\% extra MTBF} and report using the same table format (Table~\ref{NPVtable}).
